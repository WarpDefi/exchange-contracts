...
const poolConfig = [
    [3000, '0xd7538cABBf8605BdE1f4901B47B8D42c61DE0367'], // WAVAX-WARP
    [3000, '0xC33Ac18900b2f63DFb60B554B1F53Cd5b474d4cd'], // WARP-USDCe
...
async function main() {
    ...
    const description =
`# WarpDefi V2 and The New Tokenomics
TLDR: Implement WarpDefi tokenomics change with improved farming system

## What is the goal?
WarpDefi is moving to a significantly improved tokenomics system allowing the protocol to best compete with other DEXes on Avalanche and strategically allocate rewards to liquidity providers! 
...
This will shorten the total token emission period because emitting WARP over 28 years is too long of a timeframe for DeFi. The diluted market cap WarpDefi will change from 530m WARP to 230m WARP over the course of approximately 3 years from now. 

This will also grow the treasury from 13m WARP to 30m WARP over the course of 29 months, enabling WarpDefi to further innovate and continue to add new features and improve the user experience.
 
The farming pools will be focused to 37 farms at launch and can still be amended by the community via the WarpDefi multisig.
...
We will implement TreasuryVesterProxy around the TreasuryVester that will divert funds over the course of 960 days to farming rewards, the treasury, and burning excess WARP. 

We will transfer 2M WARP from CommunityTreasury to MiniChefV2 boosting the first 30 days of the new rewards system. 

...
const WARPDEFI_STAKING_POSITIONS_ADDRESS = '0x997415e58dAEa9117027d55DAB7E765748C50834';
...
async function main() {
    ...
    console.log(`Staking Contract:       ${WARPDEFI_STAKING_POSITIONS_ADDRESS}`);
    ...
    const contract = await Contract.deploy(
        TIMELOCK_ADDRESS,
        WARPDEFI_STAKING_POSITIONS_ADDRESS,
        PROPOSAL_THRESHOLD,

...
## Accessing the ABI
If you need to use any of the contract ABIs, you can install this repo as an npm package with `npm install --dev @warpdefidex/exchange-contracts`. Then import the ABI like so: `import { abi as IWarpDefiPairABI } from '@warpdefidex/exchange-contracts/artifacts/contracts/warpdefi-core/interfaces/IWarpDefiPair.sol/IWarpDefiPair.json'`.

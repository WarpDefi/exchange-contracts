...
/**
 * Custodian of community's WARP. Deploy this contract, then change the owner to be a
...
contract CommunityTreasury is Ownable {
    ...
    /**
     * Transfer WARP to the destination. Can only be called by the contract owner.
     */
    ...
    /**
     * Return the WARP balance of this contract.
     */

...
contract GovernorAlpha {
    ...
    string public constant name = "WarpDefi Governor Alpha";
    ...
    /// @notice The address of the WarpDefi Protocol Timelock
    TimelockInterface public timelock;

    /// @notice The address of the WarpDefi governance token

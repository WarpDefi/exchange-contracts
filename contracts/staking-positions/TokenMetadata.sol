...
contract TokenMetadata is AccessControlEnumerable {
    ...
    string public description =
        "This NFT perpetually receives share from the revenue generated by WarpDefi. The share of the position is positively correlated to its staked balance and staking duration.";
    string public externalUri = "https://app.warpdefi.exchange/#/stakev2";
    string public regularFontUri =
        "https://fonts.gstatic.com/s/poppins/v20/pxiEyp8kv8JHgFVrJJfecg.woff2";
    string public boldFontUri =
        "https://fonts.gstatic.com/s/poppins/v20/pxiByp8kv8JHgFVrLCz7Z1xlFQ.woff2";
    string public imageBaseUri = "https://static.warpdefi.exchange/panguardian/";
    ...
    function tokenURI(IWarpDefiStakingPositions warpdefiStakingPositions, uint256 positionId)
        external
        view
        returns (string memory)
    {
        IWarpDefiStakingPositions.ValueVariables
            memory positionValueVariables = warpdefiStakingPositions
        ...
        uint256 apr = balance == 0
            ? 0
            : (warpdefiStakingPositions.positionRewardRate(positionId) * 365 days * 100) / balance;
        uint256 earned = parseEther(warpdefiStakingPositions.positionPendingRewards(positionId));
        ...
        string memory json;
        {
            json = Base64.encode(
                abi.encodePacked(
                    '{"name":"WarpDefi Staking Position #',
                    positionId.toString(),
                    '","description":"',
                    description,
                    '","external_url":"',

...
console.log("Before running this test, set `onReward()` hook boolean (destructiveAuction) to `true` in `harvestWithoutReset()` function of WarpDefiChef. That parameters was wrongly set in Songbird. Make that change such that this actually tests the behaviour of Pangochef as deployed on Songbird. Or better, run this test by forking Songbird.");

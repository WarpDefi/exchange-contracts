...
describe('FeeCollector', function() {
    ...
    let FeeCollector, MiniChefV2, StakingRewards, WarpDefiFactory, WarpDefiPair, _Token;
    let feeCollector, warpdefiFactory, stakingRewards, _miniChefV2;
    ...
    beforeEach(async function() {
        ...
        // Enable fee switch
        await warpdefiFactory.setFeeTo(feeCollector.address);
    ...
    describe('Recovering', async function() {
        ...
        beforeEach(async function() {
            ...
            _lp0 = await smock.fake(WarpDefiPair);
    ...
    async function createPair(tokenA, tokenB) {
        await warpdefiFactory.createPair(tokenA.address, tokenB.address);
        const address = await warpdefiFactory.getPair(tokenA.address, tokenB.address);

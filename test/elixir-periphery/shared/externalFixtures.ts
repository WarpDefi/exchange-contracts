...
} from "../../../artifacts/contracts/WarpDefiV3-core/ElixirFactory.sol/ElixirFactory.json";
import {
  abi as FACTORY_V2_ABI,
  bytecode as FACTORY_V2_BYTECODE,
} from "../../../artifacts/contracts/warpdefi-core/WarpDefiFactory.sol/WarpDefiFactory.json";
import { Fixture } from "ethereum-waffle";
import { ethers, waffle } from "hardhat";
import { IWarpDefiV3Factory, IWETH9, MockTimeSwapRouter } from "../../../typechain";
...
const v3CoreFactoryFixture: Fixture<IWarpDefiV3Factory> = async ([wallet]) => {
